...
from typing import List, Tuple, Callable, Iterator, Iterable, Sequence, \
    Optional
...
class BinaryGeneticAlgorithm:
    ...
    def _new_generation(self, evaluated_population: Iterable[Tuple[IType, float]]) -> Iterator[IType]:
    ...
    def _evaluate(self, evaluation_function: Callable[[IType], float]) -> Iterator[float]:
