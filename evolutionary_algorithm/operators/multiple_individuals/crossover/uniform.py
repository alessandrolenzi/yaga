...
class UniformCrossoverOperator(MultipleIndividualOperator[SequentialIndividualType[GeneType], GeneType]):
    def __call__(
            self,
        ...
        return self.individual_structure.build_individual_from_genes_values(gene_selector())
