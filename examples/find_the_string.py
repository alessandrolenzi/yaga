...
from yaga_ga.evolutionary_algorithm.genes import CharGene
from yaga_ga.evolutionary_algorithm.individuals.uniform_individual import (
    UniformIndividualStructure,
)
from yaga_ga.evolutionary_algorithm.operators.multiple_individuals.crossover.uniform import (
